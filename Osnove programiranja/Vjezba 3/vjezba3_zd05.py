...
while a == 0:
    ...
    a = float(input('Ponovo unesite koeficijent a kvadratne jednadžbe: '))
    b = float(input('Ponovo unesite koeficijent b kvadratne jednadžbe: '))
    c = float(input('Ponovo unesite koeficijent c kvadratne jednadžbe: '))
